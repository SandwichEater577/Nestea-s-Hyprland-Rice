...
hl.on("hyprland.start", function()
    hl.exec_cmd("~/.local/bin/start-waybar")
...
hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd("playerctl --player=spotify next"), { locked=true, repeating=true })
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("playerctl --player=spotify previous"), { locked=true, repeating=true })
...
dofile(os.getenv('HOME') .. '/config/session.lua')

-- F5/F6 work with Fn-lock either on or off.
hl.bind("F5", hl.dsp.exec_cmd("playerctl --player=spotify previous"))
hl.bind("F6", hl.dsp.exec_cmd("playerctl --player=spotify next"))
